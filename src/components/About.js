    ...
    return (
        <>
            ...
            <div className='aboutContent'>
                ...
                <p className="aboutMeParagraph3">
                    When Joceliyn is not coding, she enjoys spending time with her family and friends. At home she is very
                    occupied with her two cats, Leo and Binx. She enjoys watching movies, shows, and listening to music.
                    Joceliyn is a very kind and caring person who is always willing to help others.
                </p>
            </div>
        </>
    );
